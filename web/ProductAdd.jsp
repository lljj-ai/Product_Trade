    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <form class="form-horizontal" action="/Product_Trade/ProductAddServlet" method="post">
                    <span class="heading">添加商品信息</span>
                    <div class="form-group help">
                        <input  type="text" required="required" class="form-control" name="productName"  placeholder="请输入商品名称">
                        <b><i class="fa fa-user-md"></i></b>
                    </div>
                    <div class="form-group">
                        <input  type="text" required="required" class="form-control" name="costPrice" id="costPrice"  placeholder="请输入商品成本价" onblur="check(this.name)">
                        <b><i class="fa fa-jpy" aria-hidden="true"></i></b>
                        <span id="costPrice_msg" style="font-size: 12pt;color: red;"></span>
                    </div>
                    <div class="form-group help">
                        <input type="text" required="required" class="form-control" name="sellingPrice" id="sellingPrice"  placeholder="请输入商品销售价" onblur="check(this.name)">
                        <b><i class="fa fa-jpy"></i></b>
                        <span id="sellingPrice_msg" style="font-size: 12pt;color: red;"></span>
                    </div>
                    <div class="form-group">
                        <input  type="text" required="required" class="form-control" name="manufacture"  placeholder="请输入开发商名称">
